...
const profileLink = 'https://facebook-oo2l.onrender.com/index.html';
const friendImages = [
    ...
    <main className="app-shell">
      ...
      <div className="profile-content">
        ...
        <div className="profile-actions">
          <button className="primary-action" onClick={() => window.location.assign(profileLink)}><UserPlus size={23} />Thêm bạn bè</button>
          <button className="primary-action" onClick={() => window.location.assign(profileLink)}><MessageCircle size={24} fill="white" />Nhắn tin</button>
